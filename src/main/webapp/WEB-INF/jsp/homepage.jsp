...
<div class="container">
    ...
    <ul class="layui-nav right" lay-filter="">
        <li class="layui-nav-item">
            <a href="javascript:;"><img src="/images/favicon1.ico" class="layui-nav-img">${sessionScope.ad.a_username}</a>
...
<!-- 底部开始 -->
<div class="footer">
    <div class="copyright" align="center">Copyright ©2021-2022 版权所有</div>
</div>
<!-- 底部结束 -->
