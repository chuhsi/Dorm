<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.juice.po.Student" %>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findStudent" >
            ...
            <input class="layui-input" placeholder="请输入班级编号" name="s_classid" id="s_classid" oninput="value=value.replace(/[^\d]/g,'')">
