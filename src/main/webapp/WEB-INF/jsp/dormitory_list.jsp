<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.juice.po.Dormitory" %>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findDormitory" >
            <input class="layui-input" placeholder="请输入宿舍编号" name="s_dormitoryid" id="s_dormitoryid" oninput="value=value.replace(/[^\d]/g,'')">
