<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.juice.po.StudentClean" %>
...
<head>
    ...
    <link rel="icon" href="/images/favicon1.ico" sizes="32x32" />
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findStudentClean" >
            <input class="layui-input" placeholder="请输入学号" name="s_studentid" id="s_studentid" oninput="value=value.replace(/[^\d]/g,'')">
            <input class="layui-input" placeholder="请输入姓名" name="s_name" id="s_name">
            <input class="layui-input" placeholder="请输入寝室编号" name="s_dormitoryid" id="s_dormitoryid" oninput="value=value.replace(/[^\d]/g,'')">
