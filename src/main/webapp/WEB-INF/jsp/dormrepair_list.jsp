<%@ page contentType="text/html;charset=UTF-8" language="java"  import="com.juice.po.DormRepair" %>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findDormRepair" >
            <input class="layui-input" placeholder="请输入宿舍编号" name="d_id" id="d_id" oninput="value=value.replace(/[^\d]/g,'')">
