<%@ page contentType="text/html;charset=UTF-8" language="java" import="com.juice.po.Visitor" %>
...
<div class="x-body">
    <div class="layui-row">
        <form class="layui-form layui-col-md12 x-so" action="/findVisitor" >
            ...
            <input class="layui-input" placeholder="请输入电话" name="v_phone" id="v_phone" oninput="value=value.replace(/[^\d]/g,'')">
