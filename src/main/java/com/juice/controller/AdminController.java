...
import com.juice.po.Admin;
import com.juice.po.PageInfo;
import com.juice.service.AdminService;
import com.juice.util.MD5Util;
...
public class AdminController {
    ...
    public String loginOut(Admin admin, Model model, HttpSession session) {
        session.invalidate();        //把Session数据清空，退出会话
        return "login";
    ...
    public String addAdmin(@RequestBody Admin admin) {
        admin.setA_password(MD5Util.MD5EncodeUtf8(admin.getA_password()));//通过security加密
